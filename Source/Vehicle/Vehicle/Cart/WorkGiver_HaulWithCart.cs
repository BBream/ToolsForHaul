...
namespace ToolsForHaul
{
    public class WorkGiver_HaulWithCart : WorkGiver_Scanner
    {
        ...
        public override IEnumerable<Thing> PotentialWorkThingsGlobal(Pawn pawn)
        {
            ...
            => ((aV is Vehicle_Cart) && !aV.IsForbidden(pawn.Faction)
            && ((!aV.TryGetComp<CompMountable>().IsMounted && pawn.CanReserveAndReach(aV, PathEndMode.Touch, Danger.Deadly))   //Unmounted
